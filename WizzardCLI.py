...
def echo(*values: object,
    ...
    Example of use:
        >>> import WizzardCLI
        >>> WizzardCLI.echo("Hello World", anim=True, cool=15, logs=True)
    """
...
def prompt(__prompt: object = "",
    ...
    Example of use:
        >>> import WizzardCLI
        >>> WizzardCLI.prompt("What's your name?", anim=True, cool=15, logs=True)
    """
...
def writelog(*values: object,
    ...
    Example of use:
        >>> import WizzardCLI
        >>> WizzardCLI.writelog("CLI was starting.")
    """
...
def colored(text: str,
    ...
    Example of use:
        >>> import WizzardCLI
        >>> print(WizzardCLI.colored("Hello World", "FF0000"))
        >>> print(WizzardCLI.colored("Hello World", (255, 0, 0)))
    """
    if color is None:
        return text
    else:
...
class File:
    def __init__(self, path: str, encoding: str = "UTF-8") -> None:
        ...
        Example of use:
            >>> import WizzardCLIrdCLI
            >>> file = WizzardCLI.file("test.txt", "UTF-8")F-8")
        """
...
class Strloading:
    def __init__(self, cool: float = 0.1) -> None:
        ...
        Example of use:
            >>> import WizzardCLIrdCLI
            >>> anim = WizzardCLI.strloading(cool=0.1)=0.1)
            >>> for _ in range(5):
            ...     anim.print()
            # Output will show: | → / → - → \\ → |
        """
...
class Strwait:
    def __init__(self, cool: float = 1.0) -> None:
        ...
        Example of use:
            >>> import WizzardCLIrdCLI
            >>> anim = WizzardCLI.strwait(cool=0.5)=0.5)
            >>> for _ in range(3):
            ...     anim.print()
...
def strpercent(value: float, total: float, size: int = 10, char: str = "█") -> str:
    ...
    Examples of use:
        ...
        # Output: "███████   "
        >>> print(WizzardCLI.strpercent(5, 10, size=5, char="#"))
        # Output: "##   "
    """
...
def bold(value: str) -> str:
    ...
    Example of use:
        >>> import WizzardCLI
        >>> print(WizzardCLI.bold("Bold text"))
    """
...
def italics(value: str) -> str:
    ...
    Example of use:
        >>> import WizzardCLI
        >>> print(WizzardCLI.italics("Italic text"))
    """
...
def underline(value: str) -> str:
    ...
    Example of use:
        >>> import WizzardCLI
        >>> print(WizzardCLI.underline("Underlined text"))
    """
...
def reverse(value: str) -> str:
    ...
    Example of use:
        >>> import WizzardCLI
        >>> print(WizzardCLI.reverse("Text with reverse colors"))
    """
...
def rod(value: str) -> str:
    ...
    Example of use:
        >>> import WizzardCLI
        >>> print(WizzardCLI.rod("Strikethrough text"))
    """
...
class EscapeSequence(str):
    ...
    def __init__(self, value: str = "") -> None:
        ...
        Example of use:
            >>> import WizzardCLI
            >>> esc_seq = WizzardCLI.EscapeSequence("\033[31mHello\033[0m")
        """
        super().__init__()
        self.value = value
